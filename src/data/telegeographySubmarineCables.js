...
const CABLE_GLOBE_STACK_IDS = Object.freeze(
  new Set(['satellite', 'bing-aerial', 'bing-labels', 'hd-europe', 'osm']),
);
 ...
 * keyless satellite stack, the bing stacks and osm) renders imagery on the
 * shown globe, so only the terrain pass applies.
 *
 * Cesium OSM Buildings ride on the globe stacks when an ion token is present,
 * but they are 3D-tile BUILDINGS, not ground: a submarine cable that draped
 * onto them would climb the sides of coastal towers. TERRAIN stays correct.
