...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ id: 'local-air-quality', token: 'p', disposition: 'enabled-only' }),
  Object.freeze({ id: 'local-aurora', token: 'o', disposition: 'enabled-only' }),
  Object.freeze({ id: 'local-autobahn', token: 'n', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'local-emsc-quakes', token: 'k', disposition: 'enabled-only' }),
  Object.freeze({ id: 'local-firms', token: 'w', disposition: 'enabled-only' }),
  Object.freeze({ id: 'local-gdacs', token: 'h', disposition: 'enabled-only' }),
