...
test('the voice TOOL SCHEMA is byte-identical to main — the mission mapping is instructions only', () => {
  ...
  assert.equal(block.length, 31164, 'tool schema byte length drifted from the frozen baseline');
  assert.equal(
    crypto.createHash('sha256').update(block).digest('hex'),
    '326f4b32695af5c2de049badaca96c2f8c7422e7c21447286ef235b15721b982',
