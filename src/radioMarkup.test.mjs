...
test('no unchanged Realtime tool definition drifts silently', () => {
  ...
  const TOUCHED = new Set([
    ...
    'set_map_stack',
    // Europe-first build: the location-preset enum gained 'vienna' and
    // 'berlin' (and reordered Europe ahead of the US presets) in every tool
    // that accepts a locationId.
    'control_radio',
  ]);
