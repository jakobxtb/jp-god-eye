...
const SKYLINE_SWITZERLAND: CctvCamera[] = [
  ...
  { id: 'sky-ch-geneva', lat: 46.2044, lng: 6.1432, name: 'Geneva - Jet d\'Eau', city: 'Geneva', country: 'Switzerland', feed_url: '/osiris/api/cctv/proxy?url=https%3A%2F%2Fcdn.skylinewebcams.com%2Flive497.jpg', external_url: 'https://www.skylinewebcams.com/en/webcam/suisse/geneve/geneve/geneva-jet-deau.html', source: 'SkylineWebcams' },
];
