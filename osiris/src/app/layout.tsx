  ...
  return (
    <html lang="en" dir="ltr">
      ...
      <body className="antialiased">
        {/* Return path to the other half of JP GOD EYE. A plain anchor to the
            proxy root, deliberately NOT a Next <Link>: the globe is a separate
            Vite application, so this must be a real navigation, and basePath
            must not be prepended to it. */}
        <a
          href="/"
          aria-label="Switch to the JP GOD EYE 3D globe"
          style={{
            position: 'fixed',
            top: 10,
            left: 10,
