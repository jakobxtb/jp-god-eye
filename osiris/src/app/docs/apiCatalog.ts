...
export interface ApiEndpoint {
  /** Path relative to the deployment origin, e.g. `/osiris/api/flights` */
  path: string;
...
export const API_GROUPS: ApiGroup[] = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      {
        path: '/osiris/api/region-dossier',
        method: 'GET',
  ...
  },
  {
    ...
    endpoints: [
      ...
      {
        path: '/osiris/api/cctv/stream-status',
        method: 'GET',
  ...
  },
  {
    ...
    endpoints: [
      ...
      {
        path: '/osiris/api/osint/hudsonrock',
        method: 'GET',
      ...
      {
        path: '/osiris/api/osint/sanctions',
        method: 'GET',
  ...
  "timestamp": "2026-07-29T12:00:00Z"
      ...
      {
        path: '/osiris/api/ai/briefing',
        method: 'POST',
        summary: 'Structured threat briefing in the style of a daily intelligence product.',
        returns: ['…briefing'],
        notes: 'Same `IntelligenceContext` body and same rate limit as `/osiris/api/ai/analyze`.',
        bodyExample: `{
  "earthquakes": [],
  "news": [],
  "threats": [],
  ...
  },
  {
    ...
    endpoints: [
      {
        path: '/osiris/api/github-webhook',
        method: 'POST',
